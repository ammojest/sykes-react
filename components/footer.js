    ...
    return ( 
        ...
        <div className="flex flex-col md:flex-row md:justify-between px-14 space-y-5 text-center md:text-left items-center md:items-start">
            ...
            <div className="flex items-center space-x-2 text-brand ">
                <a href="https://www.facebook.com/sykesseafood" target="_blank"><TiIcons.TiSocialFacebook size={30}/></a>
                <a href="https://twitter.com/SykesSeafood" target="_blank"><TiIcons.TiSocialTwitter size={30}/></a>
                <a href="https://www.linkedin.com/company/sykesseafood/mycompany/" target="_blank"><FaIcons.FaLinkedin size={30}/></a>
                <a href="https://www.instagram.com/sykesseafood/" target="_blank"><FaIcons.FaInstagramSquare size={30}/></a>
            </div>
        </div>
